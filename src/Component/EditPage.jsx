...
export default function EditPage() {
    ...
    const loading = async () => {
        ...
        await axios
            .get(`http://localhost:8080/product/${id}`, formData)
    ...
    const [imgfile, setImgfile] = useState(proData.imgfile);
    ...
    return (
        <div className='addpage'>
            <h1 className='text-center m-4'>Update Detail</h1>
            <form action={() => saveData()} className=' container m-5 p-5 border shadow'>
                <div class="mb-3">
